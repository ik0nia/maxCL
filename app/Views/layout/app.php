  ...
  <div class="app-shell">
    <aside class="app-sidebar" id="sidebar">
      <nav class="app-nav">
        ...
        <?php else: ?>
          <div class="app-nav-section text-success fw-semibold" style="font-size:0.95rem">Proiecte</div>
          ...
          <div class="app-nav-section text-success fw-semibold" style="font-size:0.95rem">Clienți</div>
          ...
          <div class="app-nav-section text-success fw-semibold" style="font-size:0.95rem">Plăci HPL</div>
          <a class="app-nav-link <?= str_starts_with($p, '/hpl/catalog') ? 'active' : '' ?>" href="<?= htmlspecialchars(Url::to('/hpl/catalog')) ?>">
          ...
          <div class="app-nav-section text-success fw-semibold" style="font-size:0.95rem">Magazie</div>
          ...
          <?php if (!$user || (string)($user['role'] ?? '') !== Auth::ROLE_OPERATOR): ?>
            <div class="app-nav-section text-success fw-semibold" style="font-size:0.95rem">Sistem</div>
